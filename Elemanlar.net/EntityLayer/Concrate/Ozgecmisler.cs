...
namespace EntityLayer.Concrate
{
    ...
    public class Ozgecmisler
    {
        ...
        public int DevamDurumuId { get; set; }
        ...
        public int IsDeneyimiCalismaDurumuId { get; set; }
        public int IsDeneyimiFirmaSektoruId { get; set; }
        public int IsDeneyimiCalismaSekliId { get; set; }
        public int IsDeneyimiSehirId { get; set; }
